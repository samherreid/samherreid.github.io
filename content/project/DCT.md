...
summary = "Open-source Python/ArcPy toolkit for debris cover research"

# Optional image to display on homepage (relative to `static/img/` folder).
image_preview = "dctThumb-01.jpg"
...
caption = "1993-1994 surge of Gakona Glacier, Alaska Range"
...
[Version 1 of Debris Cover Tools](https://github.com/samherreid/DebrisCoverTools) was released in May 2018 and includes a new method for mapping ice cliffs. There are several more tools in preparation and improvements to Version 1. Currently, the code calls functions within ArcPy that require an 'Advanced' ArcGIS license. 